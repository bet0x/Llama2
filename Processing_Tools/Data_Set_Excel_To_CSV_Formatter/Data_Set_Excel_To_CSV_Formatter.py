...
if __name__ == "__main__":
    ...
    input_file_path = r"D:/AI_CTS/Llama2/Processing_Tools/Data_Set_Excel_To_CSV_Formatter/V2/Hotline_Wiki_v2.xlsx"
                       
    # Replace 'output.csv' with the desired name of your output CSV file
    output_file_path = r"D:/AI_CTS/Llama2/Processing_Tools/Data_Set_Excel_To_CSV_Formatter/V2/Wiki_v2.csv"
