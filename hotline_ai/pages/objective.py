...
st.markdown( 
    ...
    * To create general knowledge base serves as centralized repository of information, encompassing of a wide range of topics and solutions relevant to customers for example **:green[Vector Database]** supported by AI powered search algorithm that provide fast and accurate retrieval of relevant information from the base 
